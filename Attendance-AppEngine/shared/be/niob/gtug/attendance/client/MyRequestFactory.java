...
import be.niob.gtug.attendance.shared.RegistrationInfoProxy;

public interface MyRequestFactory extends RequestFactory {

  @ServiceName("be.niob.gtug.attendance.server.HelloWorldService")
  public interface HelloWorldRequest extends RequestContext {
    ...
    Request<String> getWortel();
  }

  @ServiceName("be.niob.gtug.attendance.server.RegistrationInfo")
  ...
  @ServiceName("be.niob.gtug.attendance.server.Message")
